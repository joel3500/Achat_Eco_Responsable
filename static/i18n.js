...
const ECO_TRANSLATIONS = {
  fr: {
    ...
    index: {
      ...
      heroBadge: "🌱 Analyse propulsée par l'IA",
      heroTitle: "Achète mieux.",
      heroTitleAccent: "Pas plus cher, juste plus responsable.",
      heroSub: "Colle les liens de 2 produits similaires. Notre IA compare leur impact environnemental réel — matériaux, eau, CO₂e, recyclabilité — en quelques secondes.",
      heroCta: "Comparer mes premiers articles ↓",
      demoCaption: "Exemple de résultat — le score complet inclut matériaux, eau, énergie, CO₂e et recyclabilité.",
      stepOneTitle: "Colle 2 liens", stepOneText: "N'importe quel site, n'importe quel produit.",
      stepTwoTitle: "L'IA analyse", stepTwoText: "Matériaux, eau, énergie, CO₂e, recyclabilité...",
      stepThreeTitle: "Tu compares", stepThreeText: "Un score clair, le meilleur choix mis en évidence.",
    ...
    exemples: {
      ...
      catVehicleTitle: "Véhicules",
      catVehicleLi: ["Voiture électrique vs voiture à essence","Vélo ou vélo électrique vs voiture pour les courts trajets","Véhicule d'occasion vs véhicule neuf"],
  ...
  en: {
    ...
    index: {
      ...
      heroTitle: "Buy smarter.",
      heroTitleAccent: "Not pricier, just more responsible.",
      heroSub: "Paste the links of 2 similar products. Our AI compares their real environmental impact — materials, water, CO₂e, recyclability — in seconds.",
      heroCta: "Compare my first items ↓",
      demoCaption: "Example result — the full score covers materials, water, energy, CO₂e and recyclability.",
      stepOneTitle: "Paste 2 links", stepOneText: "Any site, any product.",
      stepTwoTitle: "The AI analyzes", stepTwoText: "Materials, water, energy, CO₂e, recyclability...",
      stepThreeTitle: "You compare", stepThreeText: "A clear score, the best choice highlighted.",
    ...
    exemples: {
      ...
      catVehicleTitle: "Vehicles",
      catVehicleLi: ["Electric car vs gas car","Bike or e-bike vs car for short trips","Used vehicle vs new vehicle"],
    ...
    don: {
      ...
      missionText: "Be generous, but there's no obligation at all — even $5 helps a lot. Your donations help cover server hosting costs and API costs (AI analysis, image search, web search) that power the ecological comparator, and encourage me to keep improving this tool in service of more responsible consumption.",
      ...
      footerHtml: "© All rights reserved • Fall 2025 • A project for the environment, encouraging industry lobbies to make better choices to preserve our environment for everyone. <br>\nCreated by JOEL SANDÉ, from Saguenay Lac Saint-Jean. <br><br>\nI'll say it upfront: if this project generates enough funds, a good share of it will go toward financial support for people with physical disabilities; for young women and girls, to help them escape involuntary prostitution driven by precarious circumstances; and above all for seniors around the world — my main cause, because our elders are the ones who built the society we live in today. Now that they no longer have the strength, it's our turn to return the favor. These are the three causes that pushed me to pursue a Master's degree in Biomedical Engineering. There's nothing quite like living — and growing old — in peace and in good health."
    }
  },
  ...
  es: {
    ...
    index: {
      ...
      heroBadge: "🌱 Análisis impulsado por IA",
      heroTitle: "Compra mejor.",
      heroTitleAccent: "No más caro, solo más responsable.",
      heroSub: "Pega los enlaces de 2 productos similares. Nuestra IA compara su impacto ambiental real — materiales, agua, CO₂e, reciclabilidad — en segundos.",
      heroCta: "Comparar mis primeros artículos ↓",
      demoCaption: "Ejemplo de resultado — la puntuación completa incluye materiales, agua, energía, CO₂e y reciclabilidad.",
      stepOneTitle: "Pega 2 enlaces", stepOneText: "Cualquier sitio, cualquier producto.",
      stepTwoTitle: "La IA analiza", stepTwoText: "Materiales, agua, energía, CO₂e, reciclabilidad...",
      stepThreeTitle: "Comparas", stepThreeText: "Una puntuación clara, la mejor opción resaltada.",
    ...
    exemples: {
      ...
      catVehicleTitle: "Vehículos",
      catVehicleLi: ["Auto eléctrico vs auto de gasolina","Bicicleta o bicicleta eléctrica vs auto para trayectos cortos","Vehículo usado vs vehículo nuevo"],
  ...
  de: {
    ...
    index: {
      ...
      heroBadge: "🌱 KI-gestützte Analyse",
      heroTitle: "Klüger einkaufen.",
      heroTitleAccent: "Nicht teurer, nur verantwortungsbewusster.",
      heroSub: "Füge die Links von 2 ähnlichen Produkten ein. Unsere KI vergleicht ihre tatsächliche Umweltauswirkung — Materialien, Wasser, CO₂e, Recyclingfähigkeit — in Sekunden.",
      heroCta: "Meine ersten Artikel vergleichen ↓",
      demoCaption: "Beispielergebnis — die vollständige Bewertung umfasst Materialien, Wasser, Energie, CO₂e und Recyclingfähigkeit.",
      stepOneTitle: "2 Links einfügen", stepOneText: "Egal welche Seite, egal welches Produkt.",
      stepTwoTitle: "Die KI analysiert", stepTwoText: "Materialien, Wasser, Energie, CO₂e, Recyclingfähigkeit...",
      stepThreeTitle: "Du vergleichst", stepThreeText: "Eine klare Bewertung, die beste Wahl hervorgehoben.",
    ...
    exemples: {
      ...
      catVehicleTitle: "Fahrzeuge",
      catVehicleLi: ["Elektroauto vs. Benzinauto","Fahrrad oder E-Bike vs. Auto für kurze Strecken","Gebrauchtfahrzeug vs. Neufahrzeug"],
  ...
  it: {
    ...
    index: {
      ...
      heroBadge: "🌱 Analisi basata sull'IA",
      heroTitle: "Acquista meglio.",
      heroTitleAccent: "Non più caro, solo più responsabile.",
      heroSub: "Incolla i link di 2 prodotti simili. La nostra IA confronta il loro reale impatto ambientale — materiali, acqua, CO₂e, riciclabilità — in pochi secondi.",
      heroCta: "Confronta i miei primi articoli ↓",
      demoCaption: "Esempio di risultato — il punteggio completo include materiali, acqua, energia, CO₂e e riciclabilità.",
      stepOneTitle: "Incolla 2 link", stepOneText: "Qualsiasi sito, qualsiasi prodotto.",
      stepTwoTitle: "L'IA analizza", stepTwoText: "Materiali, acqua, energia, CO₂e, riciclabilità...",
      stepThreeTitle: "Tu confronti", stepThreeText: "Un punteggio chiaro, la scelta migliore evidenziata.",
    ...
    exemples: {
      ...
      catVehicleTitle: "Veicoli",
      catVehicleLi: ["Auto elettrica vs auto a benzina","Bicicletta o bici elettrica vs auto per tragitti brevi","Veicolo usato vs veicolo nuovo"],
  ...
  ar: {
    ...
    index: {
      ...
      heroBadge: "🌱 تحليل مدعوم بالذكاء الاصطناعي",
      heroTitle: "اشترِ بذكاء أكبر.",
      heroTitleAccent: "ليس أغلى، فقط أكثر مسؤولية.",
      heroSub: "الصق روابط منتجين متشابهين. يقارن الذكاء الاصطناعي لدينا أثرهما البيئي الحقيقي — المواد، الماء، ثاني أكسيد الكربون المكافئ، قابلية إعادة التدوير — في ثوانٍ.",
      heroCta: "قارن منتجاتي الأولى ↓",
      demoCaption: "مثال على النتيجة — تشمل النتيجة الكاملة المواد والماء والطاقة وثاني أكسيد الكربون المكافئ وقابلية إعادة التدوير.",
      stepOneTitle: "الصق رابطين", stepOneText: "أي موقع، أي منتج.",
      stepTwoTitle: "الذكاء الاصطناعي يحلل", stepTwoText: "المواد، الماء، الطاقة، ثاني أكسيد الكربون المكافئ، قابلية إعادة التدوير...",
      stepThreeTitle: "تقارن", stepThreeText: "نتيجة واضحة، مع إبراز الخيار الأفضل.",
    ...
    exemples: {
      ...
      catVehicleTitle: "المركبات",
      catVehicleLi: ["سيارة كهربائية مقابل سيارة تعمل بالبنزين","دراجة أو دراجة كهربائية مقابل سيارة للمسافات القصيرة","مركبة مستعملة مقابل مركبة جديدة"],
  ...
  zh: {
    ...
    index: {
      ...
      heroBadge: "🌱 由人工智能驱动的分析",
      heroTitle: "更聪明地购物。",
      heroTitleAccent: "不是更贵，只是更负责任。",
      heroSub: "粘贴两件类似商品的链接。我们的人工智能会在几秒钟内比较它们真实的环境影响——材料、用水、二氧化碳当量、可回收性。",
      heroCta: "比较我的第一批商品 ↓",
      demoCaption: "示例结果——完整评分涵盖材料、用水、能耗、二氧化碳当量和可回收性。",
      stepOneTitle: "粘贴两个链接", stepOneText: "任何网站，任何商品。",
      stepTwoTitle: "人工智能分析", stepTwoText: "材料、用水、能耗、二氧化碳当量、可回收性……",
      stepThreeTitle: "你来比较", stepThreeText: "清晰的评分，突出显示最佳选择。",
    ...
    exemples: {
      ...
      catVehicleTitle: "车辆",
      catVehicleLi: ["电动汽车 对比 燃油汽车","自行车或电动自行车 对比 短途用车","二手车 对比 新车"],
